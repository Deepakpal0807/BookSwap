          ...
          {books.length > 0 ? (
            <ul className="flex flex-row overflow-hidden scrollbar-hide mt-4">
              {books.map((book, bookIndex) => (
                <li 
                  key={bookIndex} 
                  className="text-white w-32 rounded-2xl mx-3 h-48 border border-white justify-center items-center flex flex-col overflow-hidden text-center cursor-pointer"
