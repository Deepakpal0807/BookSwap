    ...
    <div className="flex flex-col h-screen overflow-auto">
      ...
      <div className="flex-grow  mt-4 mx-2 rounded-xl">
        ...
        <Grid2 container spacing={2} className="overflow">
          ...
          >
            <div className="w-full flex flex-col items-center justify-center p-4 text-white font-serif rounded-3xl border border-white ">
              <div class="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]"></div>{" "}
              <Typography
                variant="h5"
                component="h1"
                className="font-semibold mb-4 text-white border border-white"
              >
                {/* Profile */}
              </Typography>
              {user.avatarUrl ? (
                <img
                  ...
                  className="w-[100px] h-[100px] mb-4 rounded-full border-2 border-white"
                />
              ) : (
                <img
                  src={Avatar}
              ...
              <div className="text-center flex flex-col items-center text-white font-serif">
                <h2 className="6pp-heading text-2xl font-bold font-serif">
                  {user.name}
                </h2>
